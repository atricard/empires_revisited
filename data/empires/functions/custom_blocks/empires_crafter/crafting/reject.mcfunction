execute if data block ~ ~ ~ Items[{Slot:0b}] unless data block ~ ~ ~ Items[{Slot:0b}].tag.gui run function empires:custom_blocks/reject_item/0
...
execute if data block ~ ~ ~ Items[{Slot:9b}] unless data block ~ ~ ~ Items[{Slot:9b}].tag.gui run function empires:custom_blocks/reject_item/9
...
execute if data block ~ ~ ~ Items[{Slot:18b}] unless data block ~ ~ ~ Items[{Slot:18b}].tag.gui run function empires:custom_blocks/reject_item/18
