...
data modify storage empires:personality_name personality_name set from block ~ ~ ~ Items[{Slot:10b}].tag.saved_name_personality
data modify storage empires:personality_name personality_name_second set from block ~ ~ ~ Items[{Slot:10b}].tag.saved_name_personality_second
#
