#Turns
execute if predicate empires:turn_force run function empires:player/daily
execute if predicate empires:turn_opt run function empires:player/skip_option
#Turn Catch Up Thing
