...
execute at @s as @e[type=glow_item_frame,tag=!emp_building_inactive,distance=..1,sort=nearest,limit=1] run function empires:station_turns/type/house/check_turn
kill @s