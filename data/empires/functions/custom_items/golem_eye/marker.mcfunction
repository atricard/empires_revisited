...
#
execute as @e[type=marker,tag=emp_jobsite_eye] run function empires:custom_items/golem_eye/pos
execute at @s positioned ~ ~0.5 ~ facing entity @e[type=marker,tag=emp_jobsite_eye] feet run function empires:custom_items/golem_eye/raycast
scoreboard players reset global_score golem_eye_distance
#End
kill @e[type=marker,tag=emp_jobsite_eye]