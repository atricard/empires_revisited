...
#Buy
execute as @p[distance=..10,scores={emp_has_gui=1..}] run function empires:empires_crafter/crafting/select/block_shop/buy_ii
#Refresh
function empires:empires_crafter/crafting/pages/block_shop_ii