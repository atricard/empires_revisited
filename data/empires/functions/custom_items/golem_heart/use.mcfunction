...
execute as @e[distance=..50,type=glow_item_frame,tag=house] at @s if data block ~ ~ ~ Items[{Slot:10b}].tag.citizen run function empires:custom_items/golem_heart/reveal