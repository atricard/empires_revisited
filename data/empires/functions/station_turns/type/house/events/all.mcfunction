...
execute if entity @e[type=glow_item_frame,tag=lumbermill,tag=!empbl_inactive,distance=..50] if predicate empires:chance/025 run tag @s add emp_accident_sawblade
execute if entity @e[type=glow_item_frame,tag=factory,tag=!empbl_inactive,distance=..50] if predicate empires:chance/025 run tag @s add emp_accident_sawblade
...
execute if entity @e[type=glow_item_frame,tag=fishery,tag=!empbl_inactive,distance=..50] if predicate empires:chance/05 run tag @s add emp_accident_blast