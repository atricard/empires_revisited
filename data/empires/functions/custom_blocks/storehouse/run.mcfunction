#Set Requirements
execute if entity @s[tag=!set_goal] run function empires:custom_blocks/storehouse/set_goal
...
#Piston Break
execute unless block ~ ~ ~ barrel run function empires:custom_blocks/storehouse/drop