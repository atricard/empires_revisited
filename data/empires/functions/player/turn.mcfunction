...
execute as @e[type=glow_item_frame,tag=emp_building,tag=!emp_building_inactive,distance=..50,predicate=empires:emp_id] run function empires:station_turns/all
