...
execute if data block ~ ~ ~ Items[{Slot:10b,tag:{citizen:1b}}].tag.sick run particle dust_color_transition 0.686 0.722 0.216 2 0.000 0.000 0.000 ~ ~0.5 ~ 0.55 0.55 0.55 0 5 normal
execute if score @s emp_motivation matches 0..10 run particle angry_villager ~ ~0.5 ~ 0.55 0.55 0.55 0.05 3 normal
