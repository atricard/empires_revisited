...
scoreboard objectives remove emp_raycast_limit
scoreboard objectives remove emp_block_count
scoreboard objectives remove emp_slab_count
scoreboard objectives remove emp_wheat_count
    #Building Detector Block Goals
scoreboard objectives remove emp_block_goal
scoreboard objectives remove emp_wheat_goal
    #Empires Turn
...
scoreboard objectives remove emp_invention_cap
scoreboard objectives remove emp_money
scoreboard objectives remove emp_money_cap
scoreboard objectives remove emp_food
...
#Station Harvests
scoreboard objectives remove emp_fill_wheat
scoreboard objectives remove emp_fill_carrot
scoreboard objectives remove emp_fill_potato
scoreboard objectives remove emp_fill_beetroot
scoreboard objectives remove emp_fill_pumpkin
scoreboard objectives remove emp_fill_melon
