...
execute if entity @s[tag=workshop] run function empires:custom_blocks/workshop/set_barrel
execute if entity @s[tag=warehouse] run function empires:custom_blocks/warehouse/set_barrel
