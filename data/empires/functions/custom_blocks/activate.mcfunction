...
execute if entity @s[tag=emp_house] run scoreboard players set @s emp_cooldown 3
execute if entity @s[tag=emp_house] run scoreboard players set @s emp_motivation 100
