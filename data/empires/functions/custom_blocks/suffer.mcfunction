...
execute if entity @s[tag=lumbermill] run tellraw @a[distance=..7] [{"text":"<⚑>","color":"#00BFFF"},{"text":" Lumbermills can only be placed in forests, jungles, savannas, or taigas.","color":"red"}]
