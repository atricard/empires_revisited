...
#Click Gui
execute as @p[distance=..10,scores={emp_has_gui=1..}] run function empires:empires_crafter/crafting/select/buildings/buy_ii
#Refresh
function empires:empires_crafter/crafting/pages/buildings_ii